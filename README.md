...
| --- | --- | --- |
| [Memos](https://github.com/usememos/memos) | MIT · 61,956★ | Markdown-native private capture. |
| [Logseq](https://github.com/logseq/logseq) | AGPL-3.0 · 44,214★ | Privacy-first linked review notes. |
| [Obsidian releases](https://github.com/obsidianmd/obsidian-releases) | NOASSERTION · 20,387★ | Official releases and plugin index. |
| [Agent Skills](https://github.com/agentskills/agentskills) | Apache-2.0 · 23,762★ | Portable, inspectable skill packages. |
